...
HOST_IP=10.2.122.109:8,10.2.122.110:8
GPU_NUM=16
...
PERF_ENV="-x MCCL_FAST_WRITE_BACK=1 -x MCCL_EARLY_WRITE_BACK=15"
LIB_PATH_ENV="-x MACA_PATH=${MACA_PATH} -x LD_LIBRARY_PATH=${MACA_PATH}/lib:/${MACA_PATH}/ompi/lib:/${MACA_PATH}/ucx/lib"
ENV_VAR="-x MX_TRACER_ENABLED_MCPTI=OFF -x MXLOG_LEVEL=error ${PERF_ENV} ${LIB_PATH_ENV}"
