...
NCCL tests report the average operation time in ms, and two bandwidths in MB/s : algorithm bandwidth and bus bandwidth. This page explains what those numbers mean and what you should expect depending on the hardware used.
