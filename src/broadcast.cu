...
void BroadcastGetCollByteCount(size_t *sendcount, size_t *recvcount, size_t *paramcount,
...
testResult_t BroadcastInitData(struct threadArgs *args, ncclDataType_t type, ncclRedOp_t op,
...
void BroadcastGetBw(size_t count, int typesize, double sec, double *algBw, double *busBw,
                    int nranks)
{
...
testResult_t BroadcastRunColl(void *sendbuff, void *recvbuff, size_t count, ncclDataType_t type,
...
struct testColl broadcastTest = {"Broadcast", BroadcastGetCollByteCount, BroadcastInitData,
                                 BroadcastGetBw, BroadcastRunColl};
...
testResult_t BroadcastRunTest(struct threadArgs *args, int root, ncclDataType_t type,
...
__attribute__((weak)) testEngine ncclTestEngine = broadcastEngine;