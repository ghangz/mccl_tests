...
static ncclResult_t ncclReduce(const void *sendbuff, void *recvbuff, size_t count,
...
static ncclResult_t ncclReduceScatter(const void *sendbuff, void *recvbuff, size_t recvcount,
                                      ncclDataType_t datatype, ncclRedOp_t op, ncclComm_t comm,
                                      mcStream_t stream)
{
