...
void ReduceGetCollByteCount(size_t *sendcount, size_t *recvcount, size_t *paramcount,
...
testResult_t ReduceInitData(struct threadArgs *args, ncclDataType_t type, ncclRedOp_t op, int root,
...
testResult_t ReduceRunColl(void *sendbuff, void *recvbuff, size_t count, ncclDataType_t type,
...
struct testColl reduceTest = {"Reduce", ReduceGetCollByteCount, ReduceInitData, ReduceGetBw,
                              ReduceRunColl};
...
testResult_t ReduceRunTest(struct threadArgs *args, int root, ncclDataType_t type,
...
__attribute__((weak)) testEngine ncclTestEngine = reduceEngine;